<!-- Scrollbar -->
<template>
  <div class="container pr-80 mx-auto py-10 flex justify-left">
    <div class="w-4/12 pl-4 flex flex-col">
      <div
        class="
          bg-white
      ...
      <div
        class="w-full overflow-auto shadow bg-white"
        id="journal-scroll"
      >
        <table class="w-full">
          <tbody class="">
            ...
            >
              ...
              <td class="px-2 py-2 whitespace-no-wrap">
                ...
                <div class="leading-5 text-gray-900">
                  ...
                  <a class="text-blue-500 hover:underline" href="@/src/components/helpcenter/FAQ.vue">12345</a>
                </div>
